...
const (
	...
	DefaultRestKairosdbAddr         = "127.0.0.1:8080"
	DefaultRepeaterAddr             = ""
...
func InitGlobalConfig() error {
	...
	GlobalConfig = &Config{
		...
		RestKairosdbAddr:         cfg.MustValue(goconfig.DEFAULT_SECTION, "rest_kairosdb_addr", DefaultRestKairosdbAddr),
